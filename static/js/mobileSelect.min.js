...
(function () {
    ...
    MobileSelect.prototype = {
        ...
        init: function (config) {
            ...
            _this.checkDataType();
            _this.renderWheels(_this.wheelsData, config.cancelBtnText, config.ensureBtnText,config.flag);
            ...
            _this.cancelBtn.addEventListener("click",
            function () {
                _this.hide()
            });
        ...
        renderWheels: function (wheelsData, cancelBtnText, ensureBtnText,flag) {
            var _this = this;
            ...
            var i = "";
            if (flag == "1") {
                i = '<div class="wheels_title"><div >工作</div><div >休息</div><div >循环</div></div ><div class="panel panel2">';
            } else {
                i = '<div class="panel">'
            }

            _this.mobileSelect.innerHTML = '<div class="grayLayer"></div>' + '<div class="content">' + '<div class="btnBar">' + '<div class="fixWidth">' + '<div class="cancel">' + cancelText + "</div>" + '<div class="title"></div>' + '<div class="ensure">' + ensureText + "</div>" + "</div>" + "</div>"
                +i
                 + '<div class="fixWidth">' + '<div class="wheels ">' + "</div>" + '<div class="selectLine"></div>' + '<div class="shadowMask"></div>' + "</div>" + "</div>" + "</div>";
